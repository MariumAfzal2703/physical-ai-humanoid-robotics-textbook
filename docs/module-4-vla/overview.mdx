...
You say, “bring the red cup from the kitchen.” The robot sees, reasons, plans, and acts without hand-coded task scripts. That leap is what VLA enables.

---

## What You Will Learn

- Explain why VLA architecture matters before implementation choices.
- Apply beginner analogies to understand module 4 overview: vision-language-action.
